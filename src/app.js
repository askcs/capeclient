...
angular.module('CapeClient.Modals.User', ['ngResource'])
...
angular.module('CapeClient.Modals.Dashboard', ['ngResource'])
...
angular.module('CapeClient.Modals.Slots', ['ngResource'])
...
angular.module('CapeClient.Modals.Messages', ['ngResource'])
...
angular.module('CapeClient.Modals.Groups', ['ngResource'])
...
angular.module('CapeClient.Modals.Profile', ['ngResource'])
...
angular.module('CapeClient.Modals.Settings', ['ngResource'])
...
angular.module('CapeClient.Controllers.Timeline.Navigation', [])
...
angular.module('CapeClient.Services.Timer', ['ngResource'])
...
angular.module('CapeClient.Services.Session', ['ngResource'])
...
angular.module('CapeClient.Services.Dater', ['ngResource'])
...
angular.module('CapeClient.Services.EventBus', ['ngResource'])
...
angular.module('CapeClient.Services.Interceptor', ['ngResource'])
...
angular.module('CapeClient.Services.MD5', ['ngResource'])
...
angular.module('CapeClient.Services.Storage', ['ngResource'])
...
angular.module('CapeClient.Services.Strings', ['ngResource'])
...
angular.module('CapeClient.Services.Announcer', ['ngResource'])
...
angular.module('CapeClient.Services.Sloter', ['ngResource'])
...
angular.module('CapeClient.Services.Stats', ['ngResource'])
...
angular.module('CapeClient.Filters', [])
